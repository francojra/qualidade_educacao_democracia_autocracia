...
pisa_sci <- pisa_sci %>%
  select(-Code) %>%
  rename(performance = PISA..Mean.performance.on.the.science.scale) %>%
  view()
...
ggplot(pisa_read1, aes(x = fct_reorder(Entity, media), 
  ...
  scale_x_discrete(labels = c("Estados \nUnidos", "Alemanha",
                              "Japão", "China")) +
...
ggplot(pisa_math1, aes(x = fct_reorder(Entity, media), 
                       y = media, fill = Entity)) +
  geom_col(width = 0.9) +
  geom_errorbar(aes(ymin = media - se, ymax = media + se),
                width = 0.2, size = 0.8) +
  ...
  scale_x_discrete(labels = c("Estados \nUnidos", "Alemanha",
                              "Japão", "China")) +
  labs(x = "Países", y = "Desempenho em matemática \nPISA test score") +
  theme_ipsum(axis_text_size = 14, axis_title_size = 16) +
  theme(legend.position = "none",
        axis.text = element_text(color = "black"))

ggplot(pisa_math2, aes(x = factor(Year), y = performance,
                       color = Entity, group = Entity)) +
  geom_point(shape = 15, size = 2.5) +
  geom_line(size = 1.2) +
  scale_color_manual(values = c("#88CCEE", "#CC6677",
  ...
  scale_x_discrete(expand = expansion(mult = c(0.1,0.1))) +
  labs(x = "Tempo (anos)", 
       y = "Desempenho em matemática \nPISA test score",
       color = "Países") +
  theme_ipsum(axis_text_size = 14, 
              axis_title_size = 16) +
  theme(axis.text = element_text(color = "black"))
                                 
ggplot(pisa_math3, aes(x = factor(Year), y = performance,
                       color = Entity, group = Entity)) +
  geom_line(size = 2) +
  scale_color_manual(values = c('#1B9E77', '#999999','#E69F00'),
                     labels = c("Brasil", "China", "Estados Unidos")) +
...
ggplot(pisa_sci1, aes(x = fct_reorder(Entity, media), 
                       y = media, fill = Entity)) +
  geom_col(width = 0.9) +
  geom_errorbar(aes(ymin = media - se, ymax = media + se),
                width = 0.2, size = 0.8) +
  ...
  scale_x_discrete(labels = c("Estados \nUnidos", "Alemanha",
                              "Japão", "China")) +
  labs(x = "Países", y = "Desempenho em ciências \nPISA test score") +
  theme_ipsum(axis_text_size = 14, axis_title_size = 16) +
  theme(legend.position = "none",
        axis.text = element_text(color = "black"))

ggplot(pisa_sci2, aes(x = factor(Year), y = performance,
                       color = Entity, group = Entity)) +
  geom_point(shape = 15, size = 2.5) +
  geom_line(size = 1.2) +
  scale_color_manual(values = c("#88CCEE", "#CC6677",
  ...
  scale_x_discrete(expand = expansion(mult = c(0.1,0.1))) +
  labs(x = "Tempo (anos)", 
       y = "Desempenho em ciências \nPISA test score",
       color = "Países") +
  theme_ipsum(axis_text_size = 14, 
              axis_title_size = 16) +
  theme(axis.text = element_text(color = "black"))
                                 
ggplot(pisa_sci3, aes(x = factor(Year), y = performance,
                       color = Entity, group = Entity)) +
  geom_line(size = 2) +
  scale_color_manual(values = c('#1B9E77', '#999999','#E69F00'),
                     labels = c("Brasil", "China", "Estados Unidos")) +
